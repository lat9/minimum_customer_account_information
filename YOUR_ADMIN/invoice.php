...
*/ ?>
        <td class="main"><?php echo $order->customer['name']; ?><br /><?php echo (ACCOUNT_COMPANY == 'true') ? $order->customer['company'] : ''; ?></td>
<?php /*-eof-c-minacct*/ ?>
      </tr>
<?php } ?>
      <tr>
...
/*-bof-a-minacct*/
    if ($order->totals[$i]['class'] == 'ot_shipping') continue;  // Skip output of (free) shipping information
/*-eof-a-minacct*/
    echo '          <tr>' . "\n" .
