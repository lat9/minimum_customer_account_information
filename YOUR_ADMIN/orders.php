...
<?php /*-eof-c-minacct*/ ?>
            ...
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" valign="top"><strong><?php /*-bof-c-minaddr echo ENTRY_SHIPPING_ADDRESS;*/ echo '&nbsp'; /*-eof-c-minaddr*/ ?></strong></td>
                <td class="main"><?php /*-bof-c-minaddr echo zen_address_format($order->delivery['format_id'], $order->delivery, 1, '', '<br />');*/ echo '&nbsp'; /*-eof-c-minaddr*/ ?></td>
              </tr>
            </table></td>
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" valign="top"><strong><?php /*-bof-c-minaddrecho ENTRY_BILLING_ADDRESS; */ echo '&nbsp'; /*-eof-c-minaddr*/?></strong></td>
                <td class="main"><?php /*-bof-c-minaddr echo zen_address_format($order->billing['format_id'], $order->billing, 1, '', '<br />');*/ echo '&nbsp'; /*-eof-c-minaddr*/ ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
...
/*-bof-a-minacct*/
      if ($order->totals[$i]['class'] == 'ot_shipping') continue;  // Don't show (free) shipping
/*-eof-a-minacct*/
      echo '              <tr>' . "\n" .
...
?>
      ...
      <tr>
        <td colspan="2" align="right" class="noprint"><?php echo '<a href="' . zen_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . zen_image_button('button_invoice.gif', IMAGE_ORDERS_INVOICE) . /*-bof-d-minacct '</a> <a href="' . zen_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . zen_image_button('button_packingslip.gif', IMAGE_ORDERS_PACKINGSLIP) . -eof-d-minacct*/'</a> <a href="' . zen_href_link(FILENAME_ORDERS, zen_get_all_get_params(array('action'))) . '">' . zen_image_button('button_orders.gif', IMAGE_ORDERS) . '</a>'; ?></td>
      </tr>
<?php
...
//      $contents[] = array('text' => TEXT_INFO_DELETE_INTRO . '<br /><br /><strong>' . $cInfo->customers_firstname . ' ' . $cInfo->customers_lastname . '</strong>');
    ...
    default:
      if (isset($oInfo) && is_object($oInfo)) {
        ...
        $contents[] = array('align' => 'center', 'text' => '<a href="' . zen_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $oInfo->orders_id) . '" TARGET="_blank">' . zen_image_button('button_invoice.gif', IMAGE_ORDERS_INVOICE) . /*-bof-d-minacct '</a> <a href="' . zen_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $oInfo->orders_id) . '" TARGET="_blank">' . zen_image_button('button_packingslip.gif', IMAGE_ORDERS_PACKINGSLIP) . -eof-d-minacct*/ '</a>');
