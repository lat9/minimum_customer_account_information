 ...
 *
 * @package modules
 * @copyright Copyright 2012-2013 Vinos de Frutas Tropicales (lat9): Minimum Customer Account Information
...
/*-bof-d-minacct
  ...
  -eof-d-minacct */
  $country = zen_db_prepare_input($_POST['zone_country_id']);  /*v1.3.0a*/
  ...
  if (strlen($email_address) < ENTRY_EMAIL_ADDRESS_MIN_LENGTH) {
    ...
    } /*-bof-a-minacct*/elseif ($phpBB && $phpBB->phpbb_check_for_duplicate_email($email_address) == 'already_exists') {
      $error = true;
      $messageStack->add('create_account', ENTRY_EMAIL_ADDRESS_ERROR_EXISTS . ' (phpBB)');
      
    } elseif (strcasecmp($email_address, $email_address_confirm) != 0) {
      $error = true;
  ...
  if ($phpBB && $phpBB->phpBB['installed'] == true) {
    if (strlen($nick) < ENTRY_NICK_MIN_LENGTH)  {
      ...
      } /*-bof-c-minacct*/elseif/*eof-c-minacct*/ ($phpBB->phpbb_check_for_duplicate_nick($nick) == 'already_exists' ) {  // check phpBB for duplicate nickname
        $error = true;
...
/*-bof-d-minacct
  ...
  -eof-d-minacct */
//-minacct-v1.3.0a-added back country support
...
//-minacct-v1.3.0a-added back country support
  ...
  if ($error == true) {
    ...
    $sql_data_array = array('customers_id' => $_SESSION['customer_id'],
                            ...
                            'entry_lastname' => $lastname,/*-bof-d-minacct,
                            'entry_street_address' => $street_address,
                            'entry_postcode' => $postcode,
                            'entry_city' => $city,-eof-d-minacct*/
                            'entry_country_id' => $country);  /*minacct-v1.3.0-added back*/
...
/*-bof-d-minacct
  ...
  -eof-d-minacct */
    ...
    $_SESSION['customer_country_id'] = $country;  /*minacct-v1.3.0-added back */
/*-bof-d-minacct
 ...
 */
  $selected_country = (isset($_POST['zone_country_id']) && $_POST['zone_country_id'] != '') ? $country : SHOW_CREATE_ACCOUNT_DEFAULT_COUNTRY;  /*v1.3.0a*/
