...
<caption><h2><?php echo OVERVIEW_PREVIOUS_ORDERS; ?></h2></caption>
    ...
    <th scope="col"><?php echo /*-bof-c-minacct TABLE_HEADING_SHIPPED_TO*/ TABLE_HEADING_SOLD_TO /*-eof-c-minacct*/; ?></th>
...
?>
  <tr>
    ...
    <td><address><?php echo zen_output_string_protected($orders['order_name']) /*-bof-d-minacct . '<br />' . $orders['order_country'] -eof-d-minacct*/; ?></address></td>
