...
<?php echo zen_draw_form('account_edit', zen_href_link(FILENAME_ACCOUNT_EDIT, '', 'SSL'), 'post', 'onsubmit="return check_form(account_edit);"') . zen_draw_hidden_field('action', 'process') /*-bof-a-minacct*/ . zen_draw_hidden_field('nick', $account->fields['customers_nick']) /*-eof-a-minacct*/; ?>
...
?>
<label class="inputLabel"><?php echo ENTRY_NICK; ?></label><span><?php echo $account->fields['customers_nick'] . zen_draw_hidden_field('nick', $account->fields['customers_nick']); ?></span>
<br class="clearBoth" />
<?php
  }
/*-eof-a-minacct*/
...
<?php echo zen_get_country_list('country_id', $country_id, 'id="country"') . (zen_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="alert">' . ENTRY_COUNTRY_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
<?php
  }
//-eof-minacct-v1.3.0a  
