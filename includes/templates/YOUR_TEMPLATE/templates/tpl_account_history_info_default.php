...
<div class="ciLine">
  <br />
  <div class="forward"><span class="ciLabel"><?php echo HEADING_ORDER_DATE . '&nbsp;&nbsp;'; ?></span><span class="ciData"><?php echo zen_date_long($order->info['date_purchased']); ?></span></div>
  <div class="back"><span class="ciLabel"><?php echo HEADING_PAYMENT_METHOD . '&nbsp;&nbsp;'; ?></span><span class="ciData"><?php echo $order->info['payment_method']; ?></span></div>
</div>
<?php /*-eof-c-minacct*/ ?>
<br class="clearBoth" />
...
/*-bof-a-minacct*/
    if ($order->totals[$i]['title'] == (FREE_SHIPPING_TITLE . ':')) continue;  // Don't display "Free Shipping" text
/*-eof-a-minacct*/
?>
