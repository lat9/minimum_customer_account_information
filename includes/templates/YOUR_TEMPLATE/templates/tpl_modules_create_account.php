 ...
 * @copyright Copyright 2012-2014 Vinos de Frutas Tropicales (lat9): Minimum Customer Account Information
...
<?php echo zen_draw_input_field('email_address_confirm', '', zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40') . ' id="email-address-confirm"') . (zen_not_null(ENTRY_EMAIL_ADDRESS_CONFIRM_TEXT) ? '<span class="alert">' . ENTRY_EMAIL_ADDRESS_CONFIRM_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
